...
# Copy
(take|copy) [that]:         edit.copy()
(take|copy) all:            user.copy_all()
(take|copy) line:           user.copy_line()
(take|copy) line start:     user.copy_line_start()
(take|copy) line end:       user.copy_line_end()
(take|copy) word:           user.copy_word()
(take|copy) word left:      user.copy_word_left()
(take|copy) word right:     user.copy_word_right()
...
new line below|next:        edit.line_insert_down()
